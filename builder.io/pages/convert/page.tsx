        ...
        <section className="box-border flex relative flex-col grow shrink-0 self-stretch p-5 mx-auto w-full border border-black border-solid max-w-[1200px] min-h-[100px]">
          ...
          >
            <section className="box-border flex relative flex-col grow shrink-0 self-stretch mx-auto my-2.5 w-full border border-black border-solid max-w-[1200px]">
              ...
              <div className="box-border flex relative flex-col shrink-0 justify-start w-full h-auto grow-0">
                <div className="box-border flex relative flex-row flex-wrap shrink-0 justify-between py-1.5 pr-1.5 pl-2.5 w-full bg-neutral-300">
                  <div className="relative shrink-0 my-auto h-auto text-center text-black">
                    <p>Sequence</p>
                  </div>
                  <div className="relative shrink-0 m-auto h-auto text-center text-black">
                    <p> Uuid(Puid) </p>
                  </div>
                  <div className="relative shrink-0 m-auto h-auto text-center text-black">
                    <p>Nick Name</p>
                ...
                <div className="box-border flex relative flex-row shrink-0 justify-between pt-1.5 pb-1.5 bg-neutral-300">
                  <div className="relative shrink-0 m-auto h-auto text-center text-black">
                    <p>Sequence</p>
                  </div>
                  <div className="relative shrink-0 m-auto h-auto text-center text-black">
